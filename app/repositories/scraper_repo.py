...
class ScraperRepository:
    ...
    def get_existing_user_ids(self):
        ...
        """
        # Improved: Query only the primary key for performance
        result = self.db.query(Member.user_id).all()
    ...
    def bulk_save_members(self, members_data: list):
        ...
        # Note: We use the Member model now, not ScrapedMember
        db_objects = [Member(**data) for data in members_data]
